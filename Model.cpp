...
void Model::LoadModel(const std::string & fileName)
{
	...
	//banderas: generar con triangulos | vector normal promedio de todos los vertices unidos | vertices igual solo dibujarse 1 ves
	//flip rota la imagen de izquierda a derecha y de arriba a abajp
	if (!scene)	
	{	
...
//pa bajo asi indica la receta de cocina
